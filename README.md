...
- **`era` skill** — teaches Codex what Era is and how to work in one: signing in, provisioning a synthetic company, reaching its systems over REST or as custom MCP servers, and investigating across them.
